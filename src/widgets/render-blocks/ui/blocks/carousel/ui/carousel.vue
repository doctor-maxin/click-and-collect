...
<template>
    <section class="relative">
        <ClientOnly>
            ...
            >
                ...
                >
                    <div class="h-screen relative">
                        ...
                        <div
                            v-if="item.showText"
                            class="container py-[12rem] flex h-full absolute left-1/2 top-0 -translate-x-1/2"
                            :class="{
                        ...
                        >
                            <h2
                                class="font-semibold text-[2.75rem]"
                                :style="{
            ...
            <div
                class="container z-20 flex items-center justify-between h-full absolute left-1/2 top-0 -translate-x-1/2"
            >
                <button
