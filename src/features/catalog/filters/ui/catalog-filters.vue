...
<template>
  ...
  >
    ...
    <DialogPortal>
      ...
      <DialogContent
        class="bg-white transition-all dialog-content top-0 left-0 fixed z-44 h-screen w-full max-w-full overflow-y-auto p-4 sm:w-100 sm:overflow-visible sm:py-15.5] sm:px-14"
      >
