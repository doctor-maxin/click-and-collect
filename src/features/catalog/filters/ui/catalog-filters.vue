...
<template>
  ...
  >
    ...
    <DialogPortal>
      <DialogOverlay class="fixed dialog-overlay z-42 inset-0 bg-black/30" />
      <DialogContent
        class="bg-white transition-all dialog-content top-0 left-0 fixed z-44 h-screen w-full max-w-full overflow-y-auto p-4 sm:w-[25rem] sm:overflow-visible sm:py-[3.875rem] sm:px-[3.5rem]"
      >
